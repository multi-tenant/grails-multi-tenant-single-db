...
public class TenantHibernateEventListener extends AbstractPersistenceEventListener implements 
PreInsertEventListener, PreUpdateEventListener, LoadEventListener, PostLoadEventListener, PreDeleteEventListener
{
    ...
    public TenantHibernateEventListener(final Datastore datastore) {
        super(datastore);
    }
...
//        }
     ...
     * without a tenant id. Should we automatically assign this entity to tenant
     * X?
     */
    @Override
